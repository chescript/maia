  ...
  const retentionTips: RetentionTip[] = [
    {
      ...
      description:
        'Use the acronym "MCOL" to remember Market, Credit, Operational, and Liquidity risks.',
    ...
    },
    {
      ...
      description:
        "Think of VaR like a weather forecast: \"There's a 95% chance it won't rain more than 2 inches tomorrow.\" VaR says \"There's a 95% chance we won't lose more than $X tomorrow.\"",
    ...
    },
    {
      ...
      description:
        "Visualize risk treatment strategies using traffic lights: Red (Avoid), Yellow (Reduce), Green (Accept), Blue (Transfer).",
      example:
        "Red = Stop/Avoid the risk entirely, Yellow = Slow down/Reduce the risk, Green = Go/Accept the risk, Blue = Detour/Transfer to someone else",
      difficulty: "beginner",
    },
    {
      id: "4",
      ...
      description:
        'Practice identifying risks in everyday situations. When you see news about market volatility, ask: "What type of risk is this? How would I measure it?"',
      difficulty: "intermediate",
    },
    {
      id: "5",
      ...
      description:
        "Connect Basel III capital requirements to personal emergency funds. Just as banks need capital buffers, individuals need emergency savings.",
      example:
        "Bank needs 8% capital ratio = You need 3-6 months emergency fund",
      difficulty: "advanced",
    },
    {
      id: "6",
      ...
      description:
        "Review key formulas using spaced intervals: Day 1, Day 3, Day 7, Day 14, Day 30. This optimizes long-term retention.",
      difficulty: "intermediate",
    },
    {
      id: "7",
      ...
      description:
        'Remember the risk assessment process with "I Am Eating Tacos": Identify, Analyze, Evaluate, Treat.',
    ...
    },
    {
      ...
      description:
        "Visualize portfolio diversification as not putting all eggs in one basket. Different baskets = different asset classes.",
      difficulty: "beginner",
    },
  ];
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Memory aids, mnemonics, and study strategies to help you remember key
          concepts
        </p>
      </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Review mnemonics and analogies
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
              <div>
                ...
                <div className="text-sm text-gray-600">
                  Test retention with practice exercises
                </div>
              </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-yellow-900 mb-2">
                Pro Tips for Better Retention
              </h4>
              <ul className="text-yellow-800 text-sm space-y-1">
                <li>
                  • Create your own mnemonics - they\'re more memorable when you
                  make them
                </li>
