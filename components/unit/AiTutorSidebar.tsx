...
export function AiTutorSidebar({
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "ai",
      content:
        "Hi! I'm Maia, your AI tutor. I'm here to help you understand this unit better. You can ask me questions, request explanations, or use the quick prompts below!",
      timestamp: new Date(),
    },
  ]);
  ...
  useEffect(() => {
    if (selectedText && selectedText.trim()) {
      handleQuickPrompt(
        `Explain this text in simpler terms: "${selectedText}"`
      );
    }
  }, [selectedText]);
            ...
            {selectedText && (
              <div className="mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded text-xs">
                ...
                <Button
                  ...
                  onClick={() =>
                    handleQuickPrompt(`Explain this text: "${selectedText}"`)
                  }
                >
                  Explain This
                </Button>
