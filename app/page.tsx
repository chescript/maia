        ...
        <section className="container mx-auto px-4 py-20 lg:py-32">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed animate-in slide-in-from-bottom duration-1000 delay-400">
              ...
              interactive content, and adaptive learning paths designed for your
              success.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-in slide-in-from-bottom duration-1000 delay-600">
              ...
              <Link href="/login">
                <Button
                  variant="outline"
                  size="lg"
                  className="px-8 py-4 text-lg border-2 hover:bg-gray-50 transform hover:scale-105 transition-all duration-200"
                >
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              and proven educational methods.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Get instant, personalized explanations and guidance from our
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Engage with dynamic lessons, quizzes, flashcards, and
                  multimedia content designed for active learning.
                </p>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Experience personalized learning paths that adjust to your
                  pace, strengths, and areas for improvement.
                </p>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Stay motivated with gamified learning, badges, certificates,
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
              Join thousands of successful learners who have already discovered
              the power of AI-enhanced education.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <Link href="/signup">
                <Button
                  size="lg"
                  className="px-12 py-4 text-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-200"
                >
